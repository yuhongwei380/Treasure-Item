...
2. 核心运行参数在使用 llama-server 或 llama-cli 时，需通过以下参数激活 TurboQuant 功能：参数说明可选值-ctkKey 缓存量化类型q8_0, turbo4, turbo3, turbo2-ctvValue 缓存量化类型q8_0, turbo4, turbo3, turbo2-fa 1Flash Attention必须开启 (1)3. 推荐配置建议为了在“内存节省”与“模型智商”之间取得平衡，建议参考以下配置：
